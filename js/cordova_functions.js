...
if( /(android)/i.test(navigator.userAgent) ) {
  admobid = { // for Android --> APP_ID=ca-app-pub-3866975835282931~6310084486
    // banner: 'ca-app-pub-3940256099942544/6300978111', // for testing
    banner: 'ca-app-pub-3866975835282931/5517300383', // for production

    // interstitial: 'ca-app-pub-3940256099942544/1033173712', // for testing
    interstitial: 'ca-app-pub-3866975835282931/3668218396', // for production

    rewardvideo: 'ca-app-pub-3940256099942544/5224354917', // for testing
  };
} else if(/(ipod|iphone|ipad)/i.test(navigator.userAgent)) {
    admobid = { // for iOS --> APP_ID=ca-app-pub-3866975835282931~8841499274
       banner: 'ca-app-pub-3940256099942544/2934735716', // for testing
      //banner: 'ca-app-pub-3866975835282931/3477847170', // for production

       interstitial: 'ca-app-pub-3940256099942544/4411468910', // for testing
      //interstitial: 'ca-app-pub-3866975835282931/1458107588', // for production
...
//    navigator.splashscreen.hide();
    ...
    admob.configure({
        testDeviceIds: ['5D9AE1F853E9C3FA49E571A9D933C531',
                        '62DEFD856EA65C60DF36887F69A09DB4',
                        'c2b3c359b6efff4c15eebf1d731c7bde'],
    })
...
function byAurumLinux(){
    if(window.cordova){
        if(device.platform == "Android") navigator.app.loadUrl('https://brucomis.github.io/', { openExternal:true });
    }else{
        window.location.href="https://brucomis.github.io/";
    }
}
function otherApps(){
    if(window.cordova){
        if(device.platform == "Android") navigator.app.loadUrl('https://play.google.com/store/apps/developer?id=AurumLinux', { openExternal:true });
    }else{
        window.location.href="https://play.google.com/store/apps/developer?id=AurumLinux";
    }
}
function twitter(){
    if(window.cordova){
